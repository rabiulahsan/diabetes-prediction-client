    ...
    <div className="flex items-center justify-center my-[3%]  mx-auto ">
      <div className="">
        ...
        <p className="text-slate-500 font-semibold text-center w-[60%] mx-auto mt-[2%] leading-9">
          Predict Diabetes is a web application that uses health data to predict
          if a user has diabetes. It features Flask API, CI/CD with GitHub
          Actions, and deployment on Render. The front end, built with React and
          Tailwind CSS, delivers accurate diabetes predictions through a
